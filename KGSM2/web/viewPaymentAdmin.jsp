...
<%
    ...
    try {
        ...
        rs = stmt.executeQuery("SELECT A.*, B.USERFULLNAME FROM PAYMENT A, PARTICIPANT B WHERE A.USERID = B.USERID");
        ...
        int i=1;
            while(rs.next())
            {
                ...
                String userFullName = rs.getString(9);

                System.out.print(paymentID);
                System.out.print(categoryPay);
                System.out.print(amountPay);
                System.out.print(statusPay);
